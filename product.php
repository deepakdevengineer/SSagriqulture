...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['res_id']) && isset($_GET['action']) && $_GET['action'] == 'add') {
    ...
    // Redirect to the product page to avoid resubmission
    header("Location: product.php?res_id=" . $_GET['res_id']);
    exit();
}
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <?php $ress= mysqli_query($conn,"select * from category where rs_id='$_GET[res_id]'");
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            ...
                            <?php  
									$stmt = $conn->prepare("select * from product where rs_id='$_GET[res_id]'");
									$stmt->execute();
        ...
        <div class="row">
            ...
            <?php foreach ($products as $product) : ?>
                <div class="col-lg-4 mb-4">
                    <div class="card h-100" style="background: #222; border: 2px solid #0D9B4D; color: rgba(250, 250, 250, 0.8);">
                    <img src="admin/Res_img/product/<?php echo $product['img']; ?>" alt="Food logo">
