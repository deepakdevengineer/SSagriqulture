...
<html lang="en">
    ...
    <table id="myTable" class="table table-bordered table-striped">
        <thead class="thead-dark">
            <tr>
                <th>User Name</th> <!-- Changed from 'User' to 'User Name' -->
                <th>Product Name</th> <!-- Changed from 'Title' to 'Product Name' -->
                <th>Quantity</th>
                <th>Price</th>
                <th>Address</th>
                <th>Pincode</th>
                <th>Status</th>
                <th>Order ID</th> <!-- Added Order ID -->
                <th>Payment ID</th> <!-- Added Payment ID -->
                <th>Reg-Date</th>
                <th>Action</th>
            </tr>
        </thead>
...
echo '  <td>' . $rows['razorpay_order_id'] . '</td>'; // Displaying Razorpay Order ID
echo '  <td>' . $rows['payment_id'] . '</td>'; // Added Payment ID
