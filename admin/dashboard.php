...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-wvqTb3vFLkneRO0qBzJZDrnzHDeq0tm2l9GZkkxSrsq7PdCZ0jbtpNTDrL6LZMtfJW4FZXn4RHhu7v0gkgM9nQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
``
                            ...
                            <div class="col-md-4">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php 
                                        $result = mysqli_query($conn, 'SELECT SUM(price) AS value_sum FROM users_orders WHERE status = "closed"'); 
