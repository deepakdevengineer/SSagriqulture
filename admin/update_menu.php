...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/product/".basename($fnew);                     
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update product set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";
